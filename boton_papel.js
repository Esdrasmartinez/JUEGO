...
opciones[2] = "Tijeras";
opciones[3] = "Piedra";
var boton_papel = document.getElementById("boton_papel");
...
boton_papel.addEventListener("click",pc_opcion1);
...
//////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    img_papel.addEventListener("load",carga_papel);

    function carga_papel() {
...
else if (opciones[opcion] != opciones[2] && opciones[opcion] != opciones[1]){
        console.log("Ganaste");
