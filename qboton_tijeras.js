...
opciones[2] = "Tijeras";
opciones[3] = "Piedra";
var boton_tijera= document.getElementById("boton_tijera");
...
boton_tijera.addEventListener("click",pc_opcion1);
...
//////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    img_tijeras.addEventListener("load",carga_tijeras);

    function carga_tijeras() {
          lienzo.drawImage(img_tijeras,0,0);
}
    //////////////////////////////////////////////////////////////////////////////////////////////
      var empate = new Image();
      var fondo = new Image();
      empate.src = "empate.png";
  ...
  else if (opciones[opcion] != opciones[1] && opciones[opcion] != opciones[2]){
        console.log("Perdiste");
        var img_piedra= new Image();
        img_piedra.src = "piedra.png";
        img_piedra.addEventListener("load",mostrarPiedra);
